...
\nrscomment{@Avik what is added to the system prompt to tell it to store the avg coord and timestamp of each cluster?}

For \emph{E3}, we first give each LLM whichever of Prompts 1 and 2 were more successful in \emph{E1}, with the additional instruction ..... \nrscomment{how are we telling it to maintain avg?}, and adjusting lines 3-5 of the initial system prompt to follow Prompt 5 or Prompt 6.
...
For \emph{E4}, we first give each LLM whichever of Prompts 1 and 2 were more successful in \emph{E1}, with the additional instruction ..... \nrscomment{how are we telling it to maintain avg?}, and adjusting lines 3-5 of the initial system prompt to follow Prompt 7 or Prompt 8.
